//! Adapted from Candle (Apache-2.0, MIT License, https://github.com/huggingface/candle/blob/main/candle-transformers/src/models/xlm_roberta.rs)

use candle_core::{DType, Module, Result, Tensor};
use candle_nn::{
    embedding, layer_norm, linear, ops::softmax_last_dim, Activation, Embedding, LayerNorm, Linear,
    VarBuilder,
};
...
impl XLMRobertaModel {
    ...
    pub fn forward(
        ...
        // unused and so we will default them all to None
        let encoder_hidden_states = None;
        let encoder_attention_mask = None;
        let past_key_value = None;
